...
<h2 class="text-2xl font-bold mb-6 ml-[350px] mr-[100px]">{{ $menu->name }} – Тест</h2>
<form method="POST" action="{{ route('test.submit', $menu->id) }}" class="ml-[350px] mr-[100px]">
    @csrf
        ...
        <div class="mb-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            @foreach($question->answers as $answer)
                <label class="flex items-center mb-2">
                    <input type="radio" name="question_{{ $question->id }}" value="{{ $answer->id }}" required class="mr-3 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
